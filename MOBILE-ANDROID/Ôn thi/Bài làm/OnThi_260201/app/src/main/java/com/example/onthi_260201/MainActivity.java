...
public class MainActivity extends AppCompatActivity {
    ...
    MyDb myDb;
    void initDb() {
        myDb = new MyDb(this, "DonHangDb", null, 1);

        myDb.add(new DonHang(generateId(), "DEF", LocalDateTime.now(), 32410000, true));
        myDb.add(new DonHang(generateId(), "MNO", LocalDateTime.now(), 1040430000, false));
        myDb.add(new DonHang(generateId(), "HIJ", LocalDateTime.now(), 1003247582, true));
        myDb.add(new DonHang(generateId(), "ABC", LocalDateTime.now(), 1000000, false));
    }
...
//        LocalDateTime.of(LocalDate.parse(bundle.getString("ngay")), LocalTime.NOON);

        DonHang a = new DonHang(bundle.getString("ma"), bundle.getString("ten"), LocalDateTime.now(), bundle.getFloat("gia"), bundle.getBoolean("loai"));
